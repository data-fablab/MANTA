...
class FeasibilityConfig:
    ...
    # NOTE: no hard bump constraint — bump drag penalty is already in CD0_bump
    # (Hoerner streamlined protuberance model in compute_bump_drag).
    ...
    # w_duct_bump removed — bump penalized via drag, not hard constraint
